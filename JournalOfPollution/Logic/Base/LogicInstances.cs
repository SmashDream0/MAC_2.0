...
{
    public static class LogicInstances
    {
        static LogicInstances()
        { }
        ...
        {
            var fields = typeof(LogicInstances).GetFields(System.Reflection.BindingFlags.Public | System.Reflection.BindingFlags.Static);
